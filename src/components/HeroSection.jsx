      ...
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-10">
          ...
          <p className="text-base md:text-lg text-muted-foreground max-w-3xl mx-auto opacity-0 animate-fade-in-delay-4 leading-loose px-4">
            ...
            <br /><br />
            تجدون هنا – بحمد الله – دروسًا نافعة وفتاوى  ومؤلفات  باللغتين العربية والتارقية<br />
              للمشايخ  الشيخ سالم موريدا , الشيخ أبو أسامة ابن وقليل والشيخ  محمد أداس، والشيخ أبو الزبير الأزوادي،<br />
            والشيخ أبو إسحاق،<br />
