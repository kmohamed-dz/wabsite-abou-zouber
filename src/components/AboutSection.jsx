        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="space-y-10">
            ...
            <SheikhCard
              ...
              shortText="من علماء الدعوة السلفية المعاصرين، اشتهر بدروسه في العقيدة ونصرة السنة ورد الشبهات..."
              fullText="من أبرز طلبة العلم في الجزائر، تلقى العلم على يد كبار المشايخ، وله دروس متميزة في العقيدة والمنهج، ويُعرف بشدة حرصه على نشر التوحيد وتحذير الأمة من البدع والخرافات. نسأل الله أن ينفع به."
            />

            {/* الشيخ أبو أسامة ابن وقليل */}
            <SheikhCard
              name="فضيلة الشيخ أبو أسامة ابن وقليل"
              shortText="من الدعاة السلفيين النشطين، له دروس قيمة في الفقه والعقيدة والتزكية..."
              fullText="طالب علم متميز، حفظ القرآن وجمع بين التحصيل الشرعي والدعوي، اشتهر بحسن الخلق وكثرة الدروس والمحاضرات في المساجد والمنصات، وله جهود كبيرة في تعليم الشباب وتربيتهم على المنهج السلفي. نسأل الله أن يبارك فيه وينفع به."
            />
